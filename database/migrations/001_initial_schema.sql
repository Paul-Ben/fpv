...
-- Insert initial admin user (you'll need to create this via Supabase Auth first)
-- This is just a reference - actual user creation happens through auth.signup()
-- INSERT INTO users (id, email, full_name, role) VALUES 
--   ('00000000-0000-0000-0000-000000000001', 'admin@foodpalace.ng', 'Platform Admin', 'super_admin');
